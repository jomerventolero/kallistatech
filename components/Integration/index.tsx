        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Building Trustworthy Partnerships`,
              description: `We understand that building and maintaining trust is paramount in the digital landscape.  That's why we go beyond simply creating websites – we cultivate strong partnerships based on clear communication, transparency, and a commitment to your success.
              `,
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/trust/handshake.svg"
                  alt="Trust"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/trust/leadership.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/trust/achievements.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
