                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <p className="mt-8 max-w-2xl text-balance text-lg"></p>
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">Leveraging Tech to Drive Business Success</h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg">Your Reliable IT Partner, Offering Cutting-Edge Solutions and Continuous Support for Sustainable Growth</p>
